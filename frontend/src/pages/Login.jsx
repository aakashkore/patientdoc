...
useEffect( () => {
  ...
  return (
  <form onSubmit={onsubmitHandeller} className='min-h-[80vh] flex items-center' >
    ...
    <p className='text-2xl font-semibold'>{state === 'Sign-Up' ? 'Create Account' : "Login"}</p>
     <p>Please {state === "Sign-Up" ? "sign-up": "log in"} To book an Appointment</p>
      ...
      <button type='submit' className='bg-primary text-white w-full py-2 mt-1 rounded-md text-base'>
        {
